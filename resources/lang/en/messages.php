...
return [
    ...
    'awards_ui' => [
        'recommended_title' => 'Recommended Awards for You',
        'recommended_badge' => 'Personalized',
        ...
        'sort_by' => 'Sort by',
        'sort_name' => 'Name (A-Z)',
        'sort_points_asc' => 'Lowest Points',
        'sort_points_desc' => 'Highest Points',
        ...
        'loading' => 'Loading...',
        'error_loading' => 'Error loading awards',
        'no_filtered_awards' => 'No awards match the current filters',
        'confirm_redeem_title' => 'Confirm Redemption',
        'points' => 'points',
        'you_have_points' => 'You have :points points.',
        'after_redeem' => 'After this: :points points.',
        'confirm_redeem_question' => 'Are you sure you want to redeem this award?',
        'cancel' => 'Cancel',
        'confirm' => 'Confirm',
        'processing' => 'Processing...',
        'redeem_success' => 'Award redeemed successfully!',
        'redeem_error' => 'Redemption failed. Please try again.'
    ],
    ...
    'opinions_ui' => [
        ...
        'loading' => 'Loading...',
        'no_available' => 'No opinions available',
        'error_loading' => 'Error loading opinions',
    ...
    'footer' => [
        ...
        'copyright_dynamic' => '© :years ReciclatDAM. All rights reserved.',
    ...
    'profile_page' => [
        ...
        'level_progress' => 'Level :current: :current_name',
        'next_level' => 'Level :next: :next_name',
        'points_to_next_level' => ':points points to the next level',
        'max_level_reached' => 'Congratulations! You reached the maximum level',
        ...
        'status_procesant' => 'Processing',
        'status_entregat' => 'Delivered',
        'status_cancelat' => 'Canceled',
        'timeline_claimed' => 'Claimed',
        'timeline_processing' => 'Processing',
        'timeline_delivered' => 'Delivered',
        'no_claimed_prizes' => 'You have not claimed any prizes yet.',
        'explore_available_prizes' => 'Explore available prizes',
        ...
        'explore_available_events' => 'Explore available events',
        'points_earned' => ':points points earned',
        'view_related_product' => 'View related product',
        'no_past_events' => 'You have not participated in any event yet.',
        'confirm_delete_title' => 'Confirm deletion',
        'confirm_delete_message' => 'Are you sure you want to delete your account? This action cannot be undone.',
        'cancel' => 'Cancel',
        'delete_account' => 'Delete account',
        'profile_summary_footer' => 'Profile summary',
        'last_updated' => 'Last updated',
        'server_response_error' => 'Error in server response',
        'points_current_label' => 'Current points',
        'points_spent_label' => 'Spent points',
        'total_label' => 'Total',
        'month_jan' => 'Jan',
        'month_feb' => 'Feb',
        'month_mar' => 'Mar',
        ...
        'valid_image_error' => 'Please select a valid image (JPG, PNG or GIF).',
        'image_too_large_error' => 'Image is too large. Maximum size is 5 MB.',
        'photo_updated_success' => 'Photo updated successfully',
        'update_photo_error' => 'Error updating the photo',
        'upload_image_error' => 'Error uploading image. Please try again.'
    ],
