                    ...
                    <div class="user-avatar-container me-4">
                        @if($user->foto_perfil)
                            @if(str_starts_with($user->foto_perfil, 'https://'))
                                <img src="{{ e($user->foto_perfil) }}" class="user-avatar rounded-circle" alt="{{ __('messages.admin.profile_photo') }}">
                            @elseif(file_exists(public_path('storage/' . e($user->foto_perfil))))
                                <img src="{{ asset('storage/' . e($user->foto_perfil)) }}" class="user-avatar rounded-circle" alt="{{ __('messages.admin.profile_photo') }}">
                            @else
