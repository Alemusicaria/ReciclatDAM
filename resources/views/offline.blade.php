...
<div class="container mt-5 pt-5">
    <div class="row justify-content-center">
        <div class="col-md-8 text-center">
            ...
            <img src="{{ asset('images/offline.svg') }}" alt="Sin conexión" class="img-fluid my-4 logo-large">            <p>Para acceder a todas las funcionalidades de ReciclatDAM necesitas una conexión a internet.</p>
